<template>
  <div
    ...
    :lang="language"
  >
    <!-- LOADER: مشاور املاک — شهر در حال ساخت + کلید -->
    <Transition name="fade">
      <div v-if="loading" class="loader" role="status" aria-live="polite">
        <div class="ld-city" aria-hidden="true">
          <span class="crane"><i /><b /></span>
          <span
            v-for="(b, i) in city"
            :key="i"
            class="bld"
          ...
          />
          <span class="ld-ground" />
          <span class="ld-key">🔑</span>
        </div>
        <strong class="ld-brand">{{ brand }}</strong>
        <p>{{ t("loader") }}</p>
        <div class="ld-bar"><span :style="{ width: progress + '%' }" /></div>
        <em>{{ num(progress) }}٪</em>
      </div>
    </Transition>
    ...
    <header class="header">
      <div class="container header-in">
        ...
        <div class="actions">
          ...
          <a class="btn btn-sm desk" href="#contact">{{ t("header.talk") }}</a>
          <button
            class="burger"
            type="button"
    ...
    <main>
      ...
      >
        <div class="container hero-grid">
          ...
          <!-- HERO ART: خانه‌ی رسمی و دلنشین + کلید -->
            ...
            <div class="art">
              <div class="sky">
                ...
                ><span class="star s3">✦</span> <span class="cloud c1" /><span
                  class="cloud c2"
                />
                <span class="bird b1" /><span class="bird b2" /><span
                  class="shoot"
                />
                <span class="hill hl-a" /><span class="hill hl-b" />
                <span class="road"><i /></span>
                <div class="car"><i class="cw c-a" /><i class="cw c-b" /></div>
                <div class="tree"><i /><b /></div>
                <div class="bush"><i /><i /></div>
                <span class="shadow" />
                <div class="sign">
                  <span class="post" />
                  <div class="board">
                ...
                <div class="house-wrap">
                  <div class="house">
                    <span class="chimney"><s /><s /><s /></span>
                    <span class="roof" /><span class="attic" />
                    <div class="wall">
                      <span class="win w1" /><span class="win w2" />
                      <span class="lamp l1" /><span class="lamp l2" />
                      <span class="pot p1"><i /></span
                      ><span class="pot p2"><i /></span>
                      <div class="doorway">
                        <div class="room">
                          <span class="glow" />
                          <span class="fig f1"><i /></span
                          ><span class="fig f2"><i /></span
                          ><span class="fig f3"><i /></span>
                        </div>
                        <span class="door"><i /></span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                />
                <div class="key">
                  <i class="bow" /><i class="shaft" /><i class="teeth" />
                </div>
              </div>

              <div class="badge">{{ t("hero.product.title") }}</div>
              <div class="mini-card">
                <span>⌂</span>
                <p>
                  <small>{{
                  ...
                  ><b>{{
                    language === "fa" ? "خانه‌ای برای زندگی" : "A place to live"
                  }}</b>
                </p>
              </div>
            </div>
      ...
      <section id="about-2" class="sec">
        <div class="container split">
          ...
          <div>
            <h2>
              {{ t("about.title.line1") }} <em>{{ t("about.title.line2") }}</em>
              {{ t("about.title.line3") }}
            </h2>
            <p class="body">{{ t("about.description") }}</p>
          </div>
        </div>
      </section>
      ...
      <section id="expertise" class="sec">
        <div class="container split">
          <span class="cap">{{ t("expertise.caption") }}</span>
          <div>
            <h2>
              {{ t("expertise.title.line1") }}
              <em>{{ t("expertise.title.line2") }}</em>
            </h2>
            <p class="body">{{ t("expertise.description") }}</p>
            <div class="tags">
              <span
                v-for="tag in tags"
                :key="tag"
                :class="{ on: activeTags.includes(tag) }"
                >{{ t(`expertise.tags.${tag}`) }}</span
              >
            </div>
          </div>
        </div>
      ...
      <section class="sec">
        <div class="container">
          <div class="cta reveal">
            <div>
              <h2>
                {{ t("cta.title.line1") }} <em>{{ t("cta.title.line2") }}</em>
              </h2>
              <p class="body">{{ t("cta.description") }}</p>
            </div>
            <a class="btn" href="#contact">{{ t("cta.button") }}</a>
          </div>
        </div>
      </section>
      ...
      <section id="contact" class="sec">
        <div class="container contact">
          <div>
            <span class="cap">{{ t("office.caption") }}</span>
            <h2>
            ...
            <div class="offices">
              <article v-for="o in offices" :key="o.k" class="card">
                <small>{{ t(`office.${o.label}`) }}</small>
                <h3>{{ t(`office.${o.name}`) }}</h3>
                <p>{{ t(`office.${o.addr}`) }}</p>
                <a :href="`tel:${o.raw}`">{{ t(`office.${o.phone}`) }}</a>
                <a :href="`mailto:${email}`">{{ email }}</a>
              </article>
            </div>
          </div>
          <div class="cvis" aria-hidden="true">
            <span class="r r1" /><span class="r r2" />
            <div class="seal">
              <i class="spk k1">✦</i><i class="spk k2">✦</i>
              <div class="scene">
                <div class="orbit"><span class="sun2" /></div>
                <span class="sc" />
                <span class="gnd" />
                <div class="sh">
                  <span class="sh-chim"><s /><s /></span
                  ><span class="sh-roof" />
                  <div class="sh-wall">
                    <span class="sh-win a" /><span class="sh-win b" />
                    <span class="sh-lit" /><span class="sh-door" />
                  </div>
                </div>
                <div class="mbox">
                  <span class="mp" /><span class="mb"
                    ><span class="mflag"
                  /></span>
                </div>
                <span class="env" /><span class="tw">✦</span>
              </div>
            </div>
            <a :href="`mailto:${email}`">{{ email }}</a>
          </div>
...
const animated = reactive({ experience: 0, projects: 0, clients: 0 });
...
const navItems = [
  { id: "about", label: { en: "About", fa: "درباره ما" } },
  { id: "services", label: { en: "Services", fa: "خدمات" } },
  { id: "expertise", label: { en: "Expertise", fa: "تخصص" } },
  { id: "contact", label: { en: "Contact", fa: "تماس" } },
];
const services = [
  {
    icon: "🏡",
    title: { en: "Buying & Selling", fa: "خرید و فروش ملک" },
    description: {
  ...
  {
    icon: "📈",
    title: { en: "Investment Consulting", fa: "مشاوره سرمایه‌گذاری" },
    description: {
  ...
  {
    icon: "🔑",
    title: { en: "Rent & Lease", fa: "اجاره و رهن" },
    description: {
  ...
  {
    icon: "📐",
    title: { en: "Valuation & Appraisal", fa: "کارشناسی و ارزیابی" },
    description: {
  ...
  {
    icon: "⚖️",
    title: { en: "Legal Consulting", fa: "مشاوره حقوقی املاک" },
    description: {
  ...
  {
    icon: "🏢",
    title: { en: "Property Management", fa: "مدیریت املاک" },
    description: {
...
const stats = [
  {
    key: "experience",
    target: 12,
    label: { en: "Years experience", fa: "سال تجربه" },
  },
  {
    key: "projects",
    target: 500,
    label: { en: "Successful deals", fa: "معامله موفق" },
  },
  {
    key: "clients",
    target: 350,
    label: { en: "Happy clients", fa: "مشتری راضی" },
  },
];
...
const footerColumns = [
  ...
  },
  {
    ...
    links: [
      { label: "resourceLink1", href: "#expertise" },
      { label: "resourceLink2", href: "#expertise" },
      { label: "resourceLink3", href: "#contact" },
    ],
  },
];
...
const translations = {
  en: {
    ...
    hero: {
      ...
      product: { title: "Specialized real estate consulting" },
    },
    about: {
      caption: "About us",
      title: {
    ...
    expertise: {
      ...
      title: { line1: "Expertise", line2: "that delivers." },
      description:
    ...
    cta: {
      title: { line1: "Looking for", line2: "the right property?" },
      description:
    ...
    office: {
      caption: "Our office",
      title: { line1: "Let's find", line2: "your perfect property." },
  ...
  fa: {
    ...
    hero: {
      ...
      cta: "مشاوره رایگان",
      product: { title: "مشاوره تخصصی املاک" },
    },
    about: {
      caption: "درباره ما",
      title: {
    ...
    services: { caption: "خدمات ما" },
    expertise: {
      caption: "تخصص ما",
      title: { line1: "تخصصی", line2: "که نتیجه می‌دهد." },
      description:
    ...
    cta: {
      title: { line1: "به دنبال ملک", line2: "مناسب هستید؟" },
      description:
    ...
    office: {
      caption: "دفتر ما",
      title: { line1: "بیایید ملک", line2: "مناسب شما را پیدا کنیم." },
...
// نشانگر لغزنده‌ی نوبار
const navRef = ref(null);
const pill = reactive({ x: 0, w: 0, on: false });
...
// پارالکس ملایم: فقط CSS variable، بدون reactivity
const onPointer = (e) => {
...
const runLoader = () => {
  ...
  const tick = (now) => {
    ...
    if (p < 1) return (loadRaf = requestAnimationFrame(tick));
    setTimeout(() => {
      loading.value = false;
...
onMounted(async () => {
  try {
    const l = localStorage.getItem("sadaf-language"),
      th = localStorage.getItem("sadaf-theme");
    if (l === "fa" || l === "en") language.value = l;
    theme.value =
      th === "dark" || th === "light"
        ? th
...
/* روشن: سرمه‌ای رسمی روی زمینه‌ی عاجی، طلایی فقط برای تأکید */
[data-theme="light"] {
  --bg: #ffffff;
  --bg2: #f6f6f3;
  --panel: #ffffff;
...
/* تاریک: شب سرمه‌ای عمیق (نه مشکی خالص)، متن گرم و طلای ملایم */
[data-theme="dark"] {
  --bg: #0b1220;
  --bg2: #0f1a2e;
  --panel: #142038;
...
.bld {
  ...
  animation: rise 0.9s var(--ease) var(--d) both;
  overflow: visible;
}
.bld::after {
  content: "";
  position: absolute;
  inset: 0.7em 0.5em 0.4em;
  background: radial-gradient(circle, var(--gold-hi) 32%, transparent 38%) 0 0 /
    1em 1.2em;
  opacity: 0.85;
  animation: twinkle 2.2s ease-in-out var(--d) infinite;
}
.bld.home {
  background: linear-gradient(180deg, var(--wall), var(--bg2));
}
.bld.home::before {
  content: "";
  position: absolute;
  ...
  background: linear-gradient(135deg, var(--roof-a), var(--roof-b));
}
.ld-ground {
  position: absolute;
  left: 0;
...
.theme-btn span {
  ...
  line-height: 1;
  display: block;
  animation: spinIn 0.5s var(--ease);
}
.burger {
  display: none;
  position: relative;
...
/* --- art: همه‌چیز با em، خودکار با عرض کانتینر مقیاس می‌گیرد --- */
.art-wrap {
...
/* --- upgrades: rays, birds, sold sign, confetti, parallax --- */
.orb::before {
  content: "";
  position: absolute;
  inset: -2.6em;
...
/* --- upgrades 2: road & car, pots, lamps, shooting star, entrance --- */
.road {
  left: 0;
  right: 0;
  bottom: 0;
...
/* ============ REDUCED MOTION: صحنه‌ی ثابت و قشنگ ============ */
